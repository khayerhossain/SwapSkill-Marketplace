...
export default function Resources() {
  ...
  return (
    <div className="min-h-screen bg-black/60 p-4 md:p-8 text-white">
      {/* Hero */}
      ...
      <div className="flex w-full md:w-1/2 mb-6 gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-l-lg border border-gray-700 bg-black/40 text-white"
          />
        </div>
        <button
