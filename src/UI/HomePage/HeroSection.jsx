            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-base sm:text-lg text-muted-foreground max-w-md">
                  ...
                  and earn rewards. Learn, connect, and grow with passionate
                  people worldwide.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="px-6 py-3 bg-red-600 text-white rounded-xl font-medium hover:bg-primary/90 transition">
                  Join Now
                </button>
