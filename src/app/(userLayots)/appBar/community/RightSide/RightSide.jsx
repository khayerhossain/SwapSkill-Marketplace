...
//             Deraa started following you
//           </li>
//           <li className="hover:text-indigo-400 transition cursor-pointer">
//             Ediwp liked your photo
//           </li>
//           <li className="hover:text-indigo-400 transition cursor-pointer">
//             Praha_ liked your photo
//           </li>
//         </ul>
//       </div>
...
//             >
//               <span>{user.name}</span>
//               <button className="bg-indigo-600 text-white px-3 py-1 rounded-lg hover:bg-indigo-700 transition">
//                 Follow
//               </button>
//             </li>
//           ))}
...
// src/app/(userLayots)/appBar/RightSide/RightSide.jsx
"use client";
