...
//     try {
//       // একই API endpoint, কিন্তু POST method ব্যবহার করছি
//       const response = await fetch('/api/profile/update', {
//         method: 'POST',
//         body: formData,
//       });
...
//     setLoading(true);
//     try {
//       // একই API endpoint, কিন্তু PUT method ব্যবহার করছি
//       const response = await fetch('/api/profile/update', {
//         method: 'PUT',
//         headers: {
            ...
            <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
              <div className="text-center">
                ...
                <div className="relative inline-block mb-4 group">
                  <div className="avatar">
                    <div className="w-28 h-28 rounded-full ring-4 ring-red-500 overflow-hidden shadow-md">
                      {profile?.profileImage ? (
                        <img
                          src={profile.profileImage}
                          alt="Profile"
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-red-100 text-red-600 text-4xl font-bold">
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      {profile?.skills?.length > 0 ? (
                        profile.skills.map((skill, i) => (
                          <span
                            key={i}
                            className="badge badge-outline border-red-500 text-red-600"
                          >
                            {skill}
                          </span>
                        ))
