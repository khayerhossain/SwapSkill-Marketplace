...
export default function QuizComponent({
    ...
    return (
      <div className="max-w-lg mx-auto bg-white p-8 rounded-3xl shadow-2xl text-center border-2 border-gray-100">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            onClick={() => router.push("appBar/share-skills")}
            className="bg-gradient-to-r flex items-center justify-center gap-2 from-blue-500 to-blue-600 text-white px-8 py-4 rounded-2xl hover:from-blue-600 hover:to-blue-700 font-bold transform hover:scale-105 transition-all duration-200 shadow-lg"
          >
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white p-8 rounded-3xl shadow-2xl border-2 border-gray-100">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-6 text-gray-800 leading-relaxed  p-6 rounded-2xl border-l-4 border-blue-500">
        ...
        <div className="flex space-x-4">
          {currentQuestionIndex < quizData.questions.length - 1 ? (
            ...
            <button
              ...
              disabled={submitting}
              className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 font-bold transform hover:scale-105 transition-all duration-200 shadow-lg"
            >
